...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: |
| **Scene** (Image) | BR | 0.9889 | 0.9643 | 0.9944 | 0.9944 | 0.9874 |
| | CC | 0.9890 | 0.9664 | 0.9945 | 0.9944 | 0.9875 |
| | RAkEL | 0.9902 | 0.9705 | 0.9950 | 0.9950 | 0.9894 |
| | **EDL-ECC** *(chính)* | **0.9929** | **0.9817** | **0.9964** | **0.9964** | **0.9929** |
...
| | **EDL-ECC** *(chính)* | **0.7126** | 0.1640 | **0.7213** | **0.6587** | **0.5155** |
...
| | **EDL-ECC** *(chính)* | **0.8069** | **0.3018** | **0.7149** | **0.7059** | **0.6007** |
...
| | **EDL-ECC** *(chính)* | **0.8391** | 0.5897 | **0.6967** | **0.6187** | **0.6619** |
...
| | **EDL-ECC** *(chính)* | **0.8953** | **0.1974** | **0.4268** | **0.2267** | **0.3451** |
...
| | **EDL-ECC** *(chính)* | **0.8857** | **0.2096** | **0.3692** | **0.2188** | **0.2986** |
...
| | **EDL-ECC** *(chính)* | **0.7987** | 0.2319 | **0.5435** | **0.4252** | **0.4391** |
...
| | **EDL-ECC** *(chính)* | **0.9794** | **0.7321** | **0.9891** | **0.9778** | **0.9790** |
...
| | **EDL-ECC** *(chính)* | **0.7173** | **0.0732** | **0.6409** | **0.6290** | **0.4881** |
